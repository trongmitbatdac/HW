...
/**************************************************/
	...
	//convert to degree
	gga->lcation.D_la = (int)(gga->lcation.latitude) + ((( gga->lcation.latitude - (int)(gga->lcation.latitude)))*100.0/60.0);
	gga->lcation.D_lo = (int)(gga->lcation.longitude) + (( gga->lcation.longitude - (int)(gga->lcation.longitude))*100.0/60.0);
